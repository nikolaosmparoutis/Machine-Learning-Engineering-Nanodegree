...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float, default=0.001, metavar='LR',
                        help='learning rate (default: 0.001)')    # TODO try also learning_rate = 1e-4
    parser.add_argument('--seed', type=int, default=1, metavar='S',
                        help='random seed (default: 1)')
  
    # Model parameters
    parser.add_argument('--input_dim',type=int, default=2, metavar='Input Dim', help='feaures (default: 2)')
    parser.add_argument('--hidden_dim',type=int, default=30, metavar='Hidden', help='hidden layers (default: 30)')
    parser.add_argument('--output_dim',type=int, default=1, metavar='Classes', help='classes (default: 1)')
    ...
    model = SimpleNet(args.input_dim, arg.hidden_dim, args.output_dim)
    model.to(device)
