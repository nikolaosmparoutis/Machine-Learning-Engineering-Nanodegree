...
class Gaussian():
    ...
    def calculate_mean(self):
        ...
        """
        # sum implemented in C it is faster than for loop - no interpretation requires.
    ...
    def calculate_stdev(self, sample=True):
        ...
        self.stdev = math.sqrt( sum(deviations) /n )
    ...
    def pdf(self, x):
        ...
        denom = 1 /(self.stdev * math.sqrt(2*math.pi))
...
o=Gaussian()
o.read_data_file("numbers.txt",True)
o.plot_histogram()
x,y = o.plot_histogram_pdf(100)
